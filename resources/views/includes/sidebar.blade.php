                   ...
                   <li class="active">
                    ...
                    <li>
                        <ul class="nav nav-list nav-menu-list-style">
                            ...
                            @endif
                            @if($user->role_id!=1)
                                <li id="sport_organization"><a href="#" class="tree-toggle nav-header"><i class="fa fa-list"></i>&nbsp;&nbsp;&nbsp;&nbsp;<span>Sport Organization</span><span class="menu-collapsible-icon glyphicon glyphicon-chevron-right"></span></a>
                                ...
                                <li id="skra_activity"><a href="#" class="tree-toggle nav-header"><i class="fa fa-list"></i>&nbsp;&nbsp;&nbsp;&nbsp;<span>Annual Activities Plan</span><span class="menu-collapsible-icon glyphicon glyphicon-chevron-right"></span></a>
                                 ...
                                 <li id="achievement"><a href="#" class="tree-toggle nav-header"><i class="fa fa-list"></i>&nbsp;&nbsp;&nbsp;&nbsp;<span>Activity and Achievement</span><span class="menu-collapsible-icon glyphicon glyphicon-chevron-right"></span></a>
                                    <ul class="nav nav-list tree bullets">
                                ...
                                <li id="coach_profile"><a href="#" class="tree-toggle nav-header"><i class="fa fa-list"></i>&nbsp;&nbsp;&nbsp;&nbsp;<span>Coach Profile</span><span class="menu-collapsible-icon glyphicon glyphicon-chevron-right"></span></a>
                                    <ul class="nav nav-list tree bullets">
                                     <li><a href="{{route('coach_master.index')}}"><i class='pull-left glyphicon glyphicon-circle-arrow-right'></i>&nbsp;&nbsp;&nbsp;<span>Coach Info</span></a></li>
                                   </ul>
                                </li>
                                 <li id="games"><a href="#" class="tree-toggle nav-header"><i class="fa fa-list"></i>&nbsp;&nbsp;&nbsp;&nbsp;<span>Games Profile</span><span class="menu-collapsible-icon glyphicon glyphicon-chevron-right"></span></a>
                                    <ul class="nav nav-list tree bullets">
                                         <li><a href="{{route('games_master.create')}}"><i class='pull-left glyphicon glyphicon-circle-arrow-right'></i>&nbsp;&nbsp;&nbsp;<span>Games Info</span></a></li>
                                    </ul>
                                </li>
                                <li id="athlete_info"><a href="#" class="tree-toggle nav-header"><i class="fa fa-list"></i>&nbsp;&nbsp;&nbsp;&nbsp;<span>Athlete Information</span><span class="menu-collapsible-icon glyphicon glyphicon-chevron-right"></span></a>
                                    <ul class="nav nav-list tree bullets">
                                ...
                                <li id="training"><a href="#" class="tree-toggle nav-header"><i class="fa fa-list"></i>&nbsp;&nbsp;&nbsp;&nbsp;<span>Training Information</span><span class="menu-collapsible-icon glyphicon glyphicon-chevron-right"></span></a>
                                    <ul class="nav nav-list tree bullets">
