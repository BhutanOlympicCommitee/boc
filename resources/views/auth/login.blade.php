                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('login_custome') }}">
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            <label for="emp_id" class="col-md-4 control-label">Employee No&nbsp;&nbsp;<i class="glyphicon glyphicon-user"></i></label>
                        ...
                        <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                            <label for="password" class="col-md-4 control-label">Password&nbsp;&nbsp;<i class="glyphicon glyphicon-lock"></i></label>
